...
def generate():
    ...
    for row in db(db.manifest_layout.element<2000).select():
        elements.append({ 'name': row.name, 'type': row.type, 'x1': row.x1, 'y1': row.y1, 'x2':  row.x2, 'y2': row.y2, 'font': 'Arial', 'size': 12.0, 'bold': 0, 'italic':    0, 'underline': 0, 'foreground': 0, 'background': 0, 'align': 'I', 'text': 'logo', 'priority': 2, },)
...
#TESTING TESTING TESTING TESTING TESTING TESTING TESTING TESTING 
    elements.append({ 'name': 'Emergency_Response_Phone', 'type': 'T', 'x1': 20.00, 'y1': 115.00, 'x2': 12.0, 'y2': 12.0, 'font': 'Arial', 'size': 12.0, 'bold': 0, 'italic': 0, 'underline': 0, 'foreground': 0, 'background': 0, 'align': 'I', 'text': '', 'priority': 2, })
    
    

    elements.append( { 'name': 'Manifest_Tracking_Number', 'type': 'T', 'x1': 157.0, 'y1': 40.5, 'x2': 12.0, 'y2': 12.0, 'font': 'Arial', 'size': 12.0, 'bold': 1, 'italic': 0, 'underline': 0, 'foreground': 0, 'background': 0, 'align': 'I', 'text': '', 'priority': 2, },)
...
#    elements.append( { 'name': 'Generator_Site_Address', 'type': 'T', 'x1': 115.0, 'y1': 40, 'x2': 180.0, 'y2': 37.0, 'font': 'Arial', 'size': 10.0, 'bold': 0, 'italic': 0, 'underline': 0, 'foreground': 0, 'background': 0, 'align': 'I', 'text': '', 'priority': 2, 'multiline' : 3 },)
    ...
    f["Transporter_1_Company_Phone"] = "TransPhone1"
    f["Transporter_2_Company_Phone"] = "TransPhone2"   
