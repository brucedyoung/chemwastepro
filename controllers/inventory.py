...
def chemindexedit():
    ...
    if form.process().accepted:
       ...
       try:
            record.update_record(**dict(form.vars))#record is updated
            redirect(URL('chemindex'+str(form.vars)))
    ...
    return dict(PageHeader=PageHeader,cancelbutton=cancelbutton,form=form,hprint=hprint,hazardlist=XML(hazardlist))
